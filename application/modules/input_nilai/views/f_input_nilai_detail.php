			...
			<tr>
				...
				<td>
						<table>
							...
							<tr>
								<td>
									<?php echo $detail->nama_kriteria_detail ?>
									<input type="text" name="id_kriteria_detail[]" id="id_kriteria_detail_<?php echo $no ?>" value="<?php echo $detail->id_kriteria_detail ?>">		
								</td>
